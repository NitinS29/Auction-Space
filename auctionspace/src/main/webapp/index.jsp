          ...
          <div class="container">
            ...
            <div class="collapse navbar-collapse" id="bs-example-navbar-collapse-1">
              <div class="button navbar-right">
                  <button class="navbar-btn nav-button wow bounceInRight admin" data-wow-delay="0.8s"><a href="Users/adminLogin">Admin</a></button>
              ...
              <ul class="main-nav nav navbar-nav navbar-right">
                ...
                <li class="wow fadeInDown" data-wow-delay="0.1s"><a href="#"></a></li>
        ...
        <div class="slider-area">
            <div class="slider">
                <div id="bg-slider" class="owl-carousel owl-theme">
                  <div class="item"><img src="${imgPath}/auction1.jpg" alt="Mirror Edge"></div>
                  <div class="item"><img src="${imgPath}/auction2.jpg" alt="The Last of us"></div>
				  <div class="item"><img src="${imgPath}/auction3.jpg" alt="The Last of us"></div>
                </div>
            </div>
        </div>
        ...
        <div class="content-area">
            <div class="container">
                <div class="row page-title text-center wow bounce"  data-wow-delay="1s">
                    <h5>Recent Items for Auction</h5>
                </div>
                <div class="row jobs" data-ng-init="onloadFun()">
                    <div class="col-md-9">
                        <div class="job-posts table-responsive">
                            <table class="table" data-ng-table="myTable">
                                <tr class="odd wow fadeInUp" data-wow-delay="1s" data-ng-repeat="itemDetails in itemsList">
                                    <td class="tbl-logo"><img src="${imgPath}/job-logo1.png" alt=""></td>
                                    <td class="tbl-title"><h4><br><span class="job-type">{{itemDetails.itemDisplayName}}</span></h4></td>
                                    <td><p>{{itemDetails.description}}</p></td>
                                    <td><p><i class="icon-location"></i>{{itemDetails.location}}</p></td>
                                    <td><p>&dollar; {{itemDetails.price}}</p></td>                                    
                                </tr>
                            </table>
                        </div>
                        <div class="more-jobs">
                            <a href=""> <i class="fa fa-refresh"></i>View more items</a>
                        </div>
                    </div>
                </div>
            </div>
