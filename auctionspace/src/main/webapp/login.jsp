...
<html>
<head>
<spring:url value="/resources/static/css/login.css" var="loginCss"/> 
...
<form:form name="login-form" class="login-form" id="loginForm" modelAttribute="login" action="loginProcess" method="post">	
		<div class="header">
		...
		<div class="content">
		<form:input path="username" name="username" id="username"  class="input username" placeholder="Username" />
		<div class="user-icon"></div>
		<form:password path="password" name="password" id="password" class="input password" placeholder="Password"/>
		<div class="pass-icon"></div>		
		</div>

		<div class="footer">
		<form:button id="login" name="login" class="button">Login</form:button>
		</div>
	</form:form>
